        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_Producers_ProducerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Actors_Courses", x => new { x.ActorId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_Actors_Courses_Actors_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Actors_Courses_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_CinemaId",
                table: "Courses",
                column: "CinemaId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_ProducerId",
                table: "Courses",
                column: "ProducerId");
